...
import StaffTeam from "./StaffTeamPage/StaffTeamPage.js";
import ContactPage from "./ContactPage/ContactPage.js";
import InfoPage from "./InfoPage/InfoPage.js";
import EditSpecialty from "../containers/System/Specialty/EidtSpecialty.js";
            ...
            <div className="content-container">
              <CustomScrollbars style={{ height: "100vh", width: "100%" }}>
                <Switch>
                  ...
                  <Route path="/staff-team" component={StaffTeam} />
                  <Route path="/contact" component={ContactPage} />
                  <Route path="/info" component={InfoPage}/>
                  <Route path="/profile" component={Profile} />
                  <Route path="/edit-specialty/:id" component={EditSpecialty} />
                  <Route
                    path={path.LOGIN}
