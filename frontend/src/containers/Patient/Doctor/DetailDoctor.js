...
class DetailDoctor extends Component {
  ...
  render() {
    ...
    // Loại bỏ phần hiển thị priceId nếu không muốn hiển thị
    // Giả sử `priceId` là một trường trong detailDoctor mà bạn không muốn hiển thị, nên không sử dụng trong render
