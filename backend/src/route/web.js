...
let initWebRoutes = (app) => {
  ...
  router.get("/get-all-user-bookings", bookingController.getAllUserBooking);
  router.get(
  ...
  router.get(
    "/api/get-list-patient-for-user",
    doctorController.getListAppointmentsForUser
  );
  router.get(
    "/api/get-list-patient",
    doctorController.getListPatientForDoctor1
  );
  router.get(
    "/api/get-list-patient-user",
    doctorController.getListPatientForDoctor
  );
